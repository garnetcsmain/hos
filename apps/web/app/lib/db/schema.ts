...
CREATE TABLE IF NOT EXISTS sites (
  ...
  last_confirmed_at  TEXT                   -- last "confirmar operativo" (HOS-2026-014-01 D3): liveness freshness, SEPARATE from updated_at (bed-count freshness) so a confirm can't launder a stale bed number
);
